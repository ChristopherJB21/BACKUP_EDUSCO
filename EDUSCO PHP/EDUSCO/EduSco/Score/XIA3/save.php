...
*/
	...
	// Semester 1
	$sql1 = "SELECT * FROM tb_siswa_agama_xia3_semester1 WHERE id=$id";
	$sql2 = "SELECT * FROM tb_siswa_pkn_xia3_semester1 WHERE id=$id";
	$sql3 = "SELECT * FROM tb_siswa_indo_xia3_semester1 WHERE id=$id";
	$sql4 = "SELECT * FROM tb_siswa_math_xia3_semester1 WHERE id=$id";
	$sql5 = "SELECT * FROM tb_siswa_sejarah_xia3_semester1 WHERE id=$id";
	$sql6 = "SELECT * FROM tb_siswa_bing_xia3_semester1 WHERE id=$id";
	$sql7 = "SELECT * FROM tb_siswa_art_xia3_semester1 WHERE id=$id";
	$sql8 = "SELECT * FROM tb_siswa_or_xia3_semester1 WHERE id=$id";
	$sql9 = "SELECT * FROM tb_siswa_pkwu_xia3_semester1 WHERE id=$id";
	$sql10 = "SELECT * FROM tb_siswa_mathminat_xia3_semester1 WHERE id=$id";
	$sql11 = "SELECT * FROM tb_siswa_biologi_xia3_semester1 WHERE id=$id";
	$sql12 = "SELECT * FROM tb_siswa_fisika_xia3_semester1 WHERE id=$id";
	$sql13 = "SELECT * FROM tb_siswa_kimia_xia3_semester1 WHERE id=$id";
	$sql14 = "SELECT * FROM tb_siswa_bingminat_xia3_semester1 WHERE id=$id";
	$sql15 = "SELECT * FROM tb_siswa_bjerman_xia3_semester1 WHERE id=$id";
	
	// Semester 2
	$sql16 = "SELECT * FROM tb_siswa_agama_xia3_semester2 WHERE id=$id";
	$sql17 = "SELECT * FROM tb_siswa_pkn_xia3_semester2 WHERE id=$id";
	$sql18 = "SELECT * FROM tb_siswa_indo_xia3_semester2 WHERE id=$id";
	$sql19 = "SELECT * FROM tb_siswa_math_xia3_semester2 WHERE id=$id";
	$sql20 = "SELECT * FROM tb_siswa_sejarah_xia3_semester2 WHERE id=$id";
	$sql21 = "SELECT * FROM tb_siswa_bing_xia3_semester2 WHERE id=$id";
	$sql22 = "SELECT * FROM tb_siswa_art_xia3_semester2 WHERE id=$id";
	$sql23 = "SELECT * FROM tb_siswa_or_xia3_semester2 WHERE id=$id";
	$sql24 = "SELECT * FROM tb_siswa_pkwu_xia3_semester2 WHERE id=$id";
	$sql25 = "SELECT * FROM tb_siswa_mathminat_xia3_semester2 WHERE id=$id";
	$sql26 = "SELECT * FROM tb_siswa_biologi_xia3_semester2 WHERE id=$id";
	$sql27 = "SELECT * FROM tb_siswa_fisika_xia3_semester2 WHERE id=$id";
	$sql28 = "SELECT * FROM tb_siswa_kimia_xia3_semester2 WHERE id=$id";
	$sql29 = "SELECT * FROM tb_siswa_bingminat_xia3_semester2 WHERE id=$id";
	$sql30 = "SELECT * FROM tb_siswa_bjerman_xia3_semester2 WHERE id=$id";
