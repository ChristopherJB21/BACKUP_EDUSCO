...
public class MenuGuru_ChangePass extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceSaved){
        ...
        setContentView(R.layout.activity_menu_guru_changepass);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        ActionBar actionBar = getSupportActionBar();
        actionBar.hide();

        id = Preferences.getLoggedMapel(getBaseContext());
        ...
        switch (noKelas){
            case "1":
                ...
                t = Configuration.URL_CHANGE_TCH_XIA1;
                break;
            case "2":
                s = Configuration.URL_LOGIN_TCH_XIA2;
                t = Configuration.URL_CHANGE_TCH_XIA2;
                break;
            case "3":
                s = Configuration.URL_LOGIN_TCH_XIA3;
                t = Configuration.URL_CHANGE_TCH_XIA3;
                break;
            case "4":
                s = Configuration.URL_LOGIN_TCH_XIA4;
                t = Configuration.URL_CHANGE_TCH_XIA4;
                break;
            case "5":
                s = Configuration.URL_LOGIN_TCH_XIA5;
                t = Configuration.URL_CHANGE_TCH_XIA5;
                break;
        }
    ...
    private void getStudents(){
        class GetStudents extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MenuGuru_ChangePass.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateStudents(){
        ...
        class UpdateStudents extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MenuGuru_ChangePass.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(MenuGuru_ChangePass.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    public void Change(View view) {
        ...
        if (pass_change.equals(pass_confirm)){
            ...
            intent.putExtra("noKelas", noKelas);
